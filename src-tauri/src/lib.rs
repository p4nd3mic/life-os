...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            life_stream::life_stream_regenerate_semantics,
            life_stream::life_stream_day_thread_debug,
            life_stream::life_stream_auth_health,
            life_stream::life_stream_day_thread_reset_and_rebuild,
            life_stream::life_stream_image_candidates,
            life_stream::life_stream_image_attach,
            life_stream::life_stream_image_backfill,
            life_stream::life_stream_image_autofetch,
